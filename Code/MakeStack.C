void MakeStack() {
	...
	TCanvas *c_elec_inv_mass = new TCanvas("elec_inv_mass_Zee_MV70-140");
	THStack *h_elec_inv_mass_stack = new THStack("elec_inv_mass_Zee_MV70-140_stack", "Electron Invariant Mass ZeeMV70-140");
	...
	//h_Zee2jets_elec_inv_mass->SetFillColor(kMagenta);
	//h_Zee2jets_elec_inv_mass_NoCuts->SetFillColor(kMagenta-10);

	h_Zee_MV70_140_elec_inv_mass->SetFillColor(kBlue);
	h_Zee_MV70_140_elec_inv_mass_NoCuts->SetFillColor(kCyan);	
	
	//h_elec_inv_mass_stack->Add(h_Zee2jets_elec_inv_mass);
	//h_elec_inv_mass_stack->Add(h_Zee2jets_elec_inv_mass_NoCuts);
	h_elec_inv_mass_stack->Add(h_Zee_MV70_140_elec_inv_mass);
	h_elec_inv_mass_stack->Add(h_Zee_MV70_140_elec_inv_mass_NoCuts);
	...
	h_Zee_MV70_140_elec_inv_mass->Write();
	outfile.Close();
