...
TH1F* h_elec_inv_mass = new TH1F("elec_inv_mass", TString::Format("Dilepton Invariant Mass from Electrons in MC %s",choice.c_str()), 500, 0, 150);	
TH1F* h_muon_inv_mass = new TH1F("muon_inv_mass", TString::Format("Dilepton Invariant Mass from Muons in MC %s",choice.c_str()), 500, 0, 150);
TH1F* h_tau_inv_mass = new TH1F("tau_inv_mass", TString::Format("Dilepton Invariant Mass from Tauons in MC %s",choice.c_str()), 500, 0, 150);
TH1F* h_elec_muon_inv_mass = new TH1F("elec_muon_inv_mass", TString::Format("Dilepton Invariant Mass from ElectronMuon in MC %s",choice.c_str()), 500, 0, 150);	
TH1F* h_muon_tau_inv_mass = new TH1F("muon_tau_inv_mass", TString::Format("Dilepton Invariant Mass from MuonTau in MC %s",choice.c_str()), 500, 0, 150);
TH1F* h_elec_tau_inv_mass = new TH1F("elec_tau_inv_mass", TString::Format("Dilepton Invariant Mass from TauElectron in MC %s",choice.c_str()), 500, 0, 150);
...
TH1F* h_elec_inv_mass_NoCut = new TH1F("elec_inv_mass_NoCut", TString::Format("Invariant Mass from Electron in MC %s No Cuts",choice.c_str()), 500, 0, 150);
TH1F* h_muon_inv_mass_NoCut = new TH1F("muon_inv_mass_NoCut", TString::Format("Invariant Mass from Muon in MC %s No Cuts",choice.c_str()), 500, 0, 150);
TH1F* h_tau_inv_mass_NoCut = new TH1F("tau_inv_mass_NoCut", TString::Format("Invariant Mass from Tau in MC %s No Cuts",choice.c_str()), 500, 0, 150);
