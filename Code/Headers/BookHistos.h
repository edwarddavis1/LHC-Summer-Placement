...
/*
TH1F* h_elec_iso_etcone20 = new TString::Format("elec_etcone20", TString::Format("MC %s Electrons etcone20",choice.c_str()), 500, -20, 100);
...
TH1F* h_ljet_0_eta = new TH1F("ljet_0_eta", TString::Format("MC %s Leading Leptonic Jets Eta",choice.c_str()), 500, 0, 5);
TH1F* h_ljet_0_phi = new TH1F("ljet_0_phi", TString::Format("MC %s Leading Leptonic Jets Phi",choice.c_str()), 500, 0, 4);

TH1F* h_bjet_0_pt = new TH1F("bjet_0_pt", TString::Format("MC %s Leading b Jets pT",choice.c_str()), 500, 0, 1000);
TH1F* h_bjet_0_eta = new TH1F("bjet_0_eta", TString::Format("MC %s Leading b Jets Eta",choice.c_str()), 500, 0, 5);
TH1F* h_bjet_0_phi = new TH1F("bjet_0_phi", TString::Format("MC %s Leading b Jets Phi",choice.c_str()), 500, 0, 4);
